...
map.getView().fit([72218.342233, 5106131.380625, 81256.375988, 5112925.377249], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PC-CFL-24099</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (94 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'PROJECTE CONSTRUCTIU<br />REFORÇAMENT DEL FERM A LA C-13<br />DEL PK 8+230 AL 12+000. LLEIDA - ALCOLETGE';
            }
